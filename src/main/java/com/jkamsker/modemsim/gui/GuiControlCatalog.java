...
public final class GuiControlCatalog {
    public List<GuiControl> controls() {
        return List.of(
                ...
                control("session.dataFormat", true),
                ...
                control("state.rejectCauseType", true),
                control("state.rejectCause", true),
                control("state.signal", true),
                control("state.signalRssi", true),
                ...
                control("inject.sendDte", true),
                control("inject.sendDce", true),
                control("inject.sendParsed", true),
                control("inject.sendUrc", true),
                control("inject.applyPatch", true),
                control("fault.durationMs", true),
                control("fault.stat", true),
                control("fault.rssi", true),
                control("fault.ber", true),
                control("fault.freezeMode", true),
                ...
                control("replay.runSelected", true),
                control("replay.logFile", false),
                control("replay.hashStatus", false),
                control("replay.virtualClock", false),
                control("replay.safetyConfirm", false),
                control("replay.divergenceConfirm", false),
                control("replay.divergences", false),
                control("replay.validate", false),
                control("replay.driveFromCapturedInput", true),
