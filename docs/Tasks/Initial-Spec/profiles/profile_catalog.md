...
| `sierra-umts-airprime-standard-2130617-r7` | device-family | Ältere/klassische UMTS AirCard/AirPrime-Basis. |
| `sierra-mc-sl-umts-lte-v8` | device-family | MC/SL UMTS/LTE Extended Commands. |
...
| `sierra-em74xx-mc74xx-r3` | device-family | EM/MC74xx LTE Embedded. |
| `sierra-em75xx-emmc74x1-v8` | device-target | EM75xx und EM/MC74x1. |
| `sierra-em9-v14` | device-target | EM919X/EM7690/EM929X. |
...
| `westermo-td32-6178-2203` | device-target | TD-32 AT/S-Register. |
| `westermo-td33-6179-2203` | device-target | TD-33 AT/S-Register. |
...
| `westermo-idw90-6620-3200` | device-target | IDW-90 ISDN/Analog, AT!/AT**. |
